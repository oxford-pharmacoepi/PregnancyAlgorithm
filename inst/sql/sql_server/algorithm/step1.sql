select a.category, a.gest_value, a.person_id, a.start_date, a.type, a.value_as_number
into #raw_events
from
(
	select b.category, b.gest_value, person_id, a.CONDITION_CONCEPT_ID as CONCEPT_ID,  condition_start_date as start_date,  'Cond' as type, null as value_as_number
	...
	union all
	select b.category, b.gest_value, person_id, a.PROCEDURE_CONCEPT_ID as CONCEPT_ID, procedure_date as start_date, 'Proc' as type, null as value_as_number
	...
	union all
	select b.category, b.gest_value, person_id, a.OBSERVATION_CONCEPT_ID as CONCEPT_ID, observation_date as start_date, 'Obs' as type, value_as_number
	...
	where b.data_value = 0 

	union all
	select b.category, b.gest_value, person_id, a.MEASUREMENT_CONCEPT_ID as CONCEPT_ID, measurement_date as start_date, 'Meas' as type, value_as_number
...
join (
  select person_id, a.DRUG_CONCEPT_ID as CONCEPT_ID,  DRUG_exposure_start_date as start_date,
    'Drug' as type, null as value_as_number, e.gest_value, e.category
